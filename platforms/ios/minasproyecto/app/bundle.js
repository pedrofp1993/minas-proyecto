...
var BusComponent = /** @class */ (function () {
    function BusComponent(router) {
        ...
        this.ConfiguracionAndroidcol4 = [{ tamañomenora320: 68, tamañomayora350: 82, tamañomayora400: 88 }];
    ...
    BusComponent.prototype.ponerImagen2 = function () {
        for (var i in this.Asientos) {
            if (tns_core_modules_platform_platform__WEBPACK_IMPORTED_MODULE_2__["isAndroid"]) {
                if (this.obtenercol1() == 4 && this.Asientos[i].nivel == 1) {
                    ...
                    else if (350 < tns_core_modules_platform_platform__WEBPACK_IMPORTED_MODULE_2__["screen"].mainScreen.widthDIPs && 400 > tns_core_modules_platform_platform__WEBPACK_IMPORTED_MODULE_2__["screen"].mainScreen.widthDIPs) {
                        //477
                        //468
                    ...
                    else if (400 < tns_core_modules_platform_platform__WEBPACK_IMPORTED_MODULE_2__["screen"].mainScreen.widthDIPs) {
    ...
    BusComponent.prototype.calcularTamañoImagenes = function () {
    };
